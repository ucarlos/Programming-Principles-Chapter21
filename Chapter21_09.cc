/*
 * -----------------------------------------------------------------------------
 * Created by Ulysses Carlos on 05/29/2020 at 11:20 PM
 * 
 * Chapter21_09.cc
 ...
 * in the first file, read it into a list<Order> , sort it by address 
 * (of customer), and write it back out to a file. Merge the two files into a 
...
int main(void){
    ...
    sort(vo.begin(), vo.end(), [](const Order &a, const Order &b) { return a.get_name() < b.get_name();});
